...
terraform {
  source = "git::https://${local.vars.locals.git_repo_token}@dev.azure.com/ddcdipostar/Fiducia%20System/_git/terraform.code//infra/networking/peering_vpc?ref=${local.vars.locals.module_version.peering_vpc}"
}
